...
public class Credits : MonoBehaviour
{
    ...
    [SerializeField] private string path = "Assets/Scripts/EndingCredits.txt";
    [SerializeField] private Font m_Font;
    [SerializeField] private Color headerColor = Color.red;
    [SerializeField] private Color nameColor = Color.white;
    [SerializeField] private int headerSize = 30;
    [SerializeField] private int nameSize = 30;
    [SerializeField] private float scrollSpeed = 0.5f;
    [SerializeField] private int screenSpaceInDivisions = 7;
    ...
    void Start()
    {
        ...
        for(int i = 0; i < headers.Count; i++)
        {
            ...
            for(int j = 0; j < titles[i].Count; j++)
            {
                ...
                GameObject obj = newText(titles[i][j], false);
                obj.transform.position = nextPosition;
                creditsTexts.Add(obj);
                lastPosition = nextPosition;
            }
        }
    }
